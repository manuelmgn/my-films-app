...
function FilmCard({
  ...
  return (
    <div
      key={film.id}
      className="bg-black text-[var(--color-20)] rounded-lg  hover:scale-103 shadow-xs hover:shadow-xl shadow-[var(--color-1)] transition-transform duration-200 cursor-pointer"
